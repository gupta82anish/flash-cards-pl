...
| `ContentView.swift` | **Scan tab**: Polish-support check, **page-type picker (Auto/Table/Numbered)**, Scan, Choose photos, language-correction toggle, **Save N cards** (skips duplicates), Copy results |
